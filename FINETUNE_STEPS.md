...
1. Update config file paramters as per TPU size and Cloud or Gdrive 

- Config file for finetune is at "mesh-transformer-jax/configs/6B_roto_256_ft.json


2. Loginto your google drive and create directories for 
- MyDrive/colab_data/ckpt_dir
- MyDrive/colab_data/finetuned_ckpt_dir

3. Upload checkpoint data to google drive or g drive
...
8. Update or change config file "6B_roto_256_ft.json" to finetune your model
